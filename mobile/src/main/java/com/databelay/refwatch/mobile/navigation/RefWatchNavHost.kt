package com.databelay.refwatch.mobile.navigation // Create this package
...
import com.databelay.refwatch.mobile.auth.AuthScreen
import com.databelay.refwatch.mobile.auth.AuthState
import com.databelay.refwatch.mobile.auth.AuthViewModel
import com.databelay.refwatch.common.Game // Your Game class
import com.databelay.refwatch.common.SimpleIcsParser
import com.databelay.refwatch.mobile.games.GameListScreen
import com.databelay.refwatch.mobile.games.MobileGameViewModel
import com.databelay.refwatch.mobile.games.AddEditGameScreen // Your new screen
import com.databelay.refwatch.mobile.games.AddEditGameViewModel
    ...
    NavHost(
        ...
        composable(MobileNavRoutes.GAME_LIST_SCREEN) {
            ...
            GameListScreen(
                ...
                onSendPing = { mobileGameViewModel.sendPing() }
            )
        }
