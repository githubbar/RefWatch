package com.databelay.refwatch.presentation.components // << YOUR PACKAGE NAME
...
fun ConfirmationDialog(
    ...
    onConfirm: () -> Unit,
    onDismiss: () -> Unit,
    icon: androidx.compose.ui.graphics.vector.ImageVector = Icons.Filled.Warning, // Allow custom icon
