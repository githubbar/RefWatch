package com.databelay.refwatch.presentation.components // Or your components package
...
@OptIn(androidx.compose.foundation.ExperimentalFoundationApi::class) // PagerState is experimental
@Composable
